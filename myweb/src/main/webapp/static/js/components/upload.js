...
(function ($) {
	...
	//var needOverlay = ($.browser.msie && parseInt($.browser.version.split('.')[0]) < 10) || $.browser.opera || ($.browser.mozilla && parseInt($.browser.version.split('.')[0]) < 3);
	var needOverlay = undefined;
